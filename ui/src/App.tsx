...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 w-full">
      ...
      <main
        className={`pb-8 ${
          !noNavPaths.includes(location.pathname.toLowerCase()) ? "pt-4" : ""
        }`}
      >
        {children}
      </main>
  ...
  <Layout>
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        {/* Handles redirect for logged-in users */}
        ...
        <Route
          ...
          element={
            <div className="text-center p-10">
              ...
              <RouterLink
                to="/"
                className="mt-6 inline-block bg-pink-500 text-white px-6 py-2 rounded hover:bg-pink-600"
              >
                Go to Homepage
              </RouterLink>
            </div>
